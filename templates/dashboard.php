<?php $active_tab = ! empty( $_GET['tab'] ) ? sanitize_text_field( $_GET['tab'] ) : 'graphs'; ?>
...
<div id="affwp-affiliate-dashboard">
	...
	<?php if ( 'active' == affwp_get_affiliate_status( affwp_get_affiliate_id() ) ) : ?>
		...
		<h3>Welcome back, <?php echo affiliate_wp()->affiliates->get_affiliate_name( affwp_get_affiliate_id() ); ?>!</h3>
		...
		<ul id="affwp-affiliate-dashboard-tabs">
			...
			<li class="affwp-affiliate-dashboard-tab<?php echo $active_tab == 'create-account' ? ' active' : ''; ?>">
				<a href="<?php echo esc_url( add_query_arg( 'tab', 'create-account', get_permalink( affiliate_wp()->settings->get( 'affiliates_page' ) ) ) ); ?>"><?php _e( 'Add Customer', 'affiliate-wp' ); ?></a>
			</li>
			<li class="affwp-affiliate-dashboard-tab<?php echo $active_tab == 'view-customers' ? ' active' : ''; ?>">
				<a href="<?php echo esc_url( add_query_arg( 'tab', 'view-customers', get_permalink( affiliate_wp()->settings->get( 'affiliates_page' ) ) ) ); ?>"><?php _e( 'View Customers', 'affiliate-wp' ); ?></a>
			</li>
			<li class="affwp-affiliate-dashboard-tab<?php echo $active_tab == 'view-orders' ? ' active' : ''; ?>">
				<a href="<?php echo esc_url( add_query_arg( 'tab', 'view-orders', get_permalink( affiliate_wp()->settings->get( 'affiliates_page' ) ) ) ); ?>"><?php _e( 'View Unpaid Orders', 'affiliate-wp' ); ?></a>
			</li>
